public class Classlevel7 implements Runnable {
	@Override
	public void run()
	{
		classLock();
	...
	public void classLock()
	{
		...
		synchronized(Classlevel7.class)
		{
	...
	// TODO Auto-generated method stub
		Classlevel7 test1 = new Classlevel7();
		Thread t1 = new Thread(test1);
		Thread t2 = new Thread(test1);
		Classlevel7 test2 = new Classlevel7();
		Thread t3 = new Thread(test2);
		Thread t4 = new Thread(test2);
		Classlevel7 test3 = new Classlevel7();
